...
//		int bufferSize = WideCharToMultiByte(CP_ACP, 0, name, -1, nullptr, 0, nullptr, nullptr);
//		if (bufferSize == 0) {
//			// Handle the error, if any
//			return security::internal::debug_results::conversion_error;
//		}
//
//		// Allocate a buffer for the converted string
//		char* nameA = new char[bufferSize];
//
//		// Convert the wchar_t* to LPCSTR
//		if (WideCharToMultiByte(CP_ACP, 0, name, -1, nameA, bufferSize, nullptr, nullptr) == 0) {
//			// Handle the error, if any
//			delete[] nameA;
//			return security::internal::debug_results::conversion_error;
//		}
//
//		// Use LPCSTR in FindWindow
//		if (FindWindow(nameA, 0)) {
